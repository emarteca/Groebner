...
\begin{example} % CITE CN
  ...
  \end{equation*}
  Then, computing the reduction of this S-polynomial over current basis ${G}$ yields:\\
  Reduction over ${G}$: 
  \begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Over ${G}$: this is irreducible; now, set ${G_4 = -2xz^2 + 5x - 2y + 3z}$
  \end{enumerate}
  Successive reduction over ${G_2}$:
\end{example}
