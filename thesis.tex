...
x1+x7+x11+x15+x16+x22+x23+x24+x1*x3+x1*x5+\\x1*x6+x1*x7+x1*x8+x1*x9+x1*x11+x1*x13+x1*x14+x1*x15+\\x1*x17+x1*x19+x1*x20+x1*x21+x1*x24+x1*x25+\\x2*x7+x2*x9+x2*x11+x2*x15+x2*x16+x2*x17+\\x2*x18+x2*x21+x3*x4+x3*x5+x3*x7+x3*x9+x3*x11+x3*x13+\\x3*x16+x3*x17+\\
...\\
...\\
