...
\begin{note}
  ...
  \textbf{Proof}: Consider the second criterion BRO I NEED A PROOF HERE AWKS
  I think it has v(a) = 1 \forall a.
\end{note}
...
SO, WHAT IS RELATION BETWEEN EUD, UFD, RING, ETC
...
An ideal is defined in terms of a commutative ring, DEFINITION ON NOTES
