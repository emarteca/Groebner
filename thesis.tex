...
\begin{enumerate}
  ...
  \item Then, create a UNIX shared library file as follows: $$\texttt{gcc -shared -Wl,-soname,<yourlib>.so.1 -o <yourlib>.so.1.0.1 <yourfile>.o -lc -lgmp}$$
...
Notice the matching names for the function and parameters between the C and \texttt{define\_external}.  More details on the functionality and options available with \texttt{define\_external}, including plugins for other languages (Java and FORTRAN), can be found in the Maple manual online. CITE
